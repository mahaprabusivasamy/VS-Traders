...
export default function Fish_seafoods() {
  return (
      ...
      <Image1 pic={Fish}/>
      {/* </div> */}
      <PriceContainer name1={'Prawn'} price1={'500'} low1={'499'} high1={'809'} name2={'Crab'} price2={'740'} low2={'699'} high2={'1200'}/>
      <Availabilty/>
      </div>
      {/* quotes */}
      <div className="quote">
